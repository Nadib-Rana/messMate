...
export default registerAs("storage", () => ({
  ...
  bucket: process.env.STORAGE_BUCKET || process.env.MINIO_BUCKET || "messmate-uploads",
  region: process.env.STORAGE_REGION || process.env.MINIO_REGION || "us-east-1",
  publicUrl: process.env.STORAGE_PUBLIC_URL || "http://localhost:9000/messmate-uploads",
}));
